...
public class Admin_TaiKhoanFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_taikhoan_admin, container, false);
        tv_hoten=v.findViewById(R.id.tv_hoten_a);
        et_hoten=v.findViewById(R.id.et_hoten_a);
        tv_email=v.findViewById(R.id.tv_email_a);
        et_diachi=v.findViewById(R.id.et_diachi_a);
        et_sdt=v.findViewById(R.id.et_sdt_a);
        bt_doimk=v.findViewById(R.id.bt_doimk_a);
        bt_luu=v.findViewById(R.id.bt_luu_a);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (hoten != null && !hoten.isEmpty()) {
                        ...
                        tv_hoten.setText("Admin");  // Hiển thị "User" nếu không có tên
                    }
                    et_sdt.setText(sdt);
                    et_diachi.setText(diachi);
                } else {
                    // Nếu không có thông tin người dùng trong Firebase
                    tv_hoten.setText("Admin");
